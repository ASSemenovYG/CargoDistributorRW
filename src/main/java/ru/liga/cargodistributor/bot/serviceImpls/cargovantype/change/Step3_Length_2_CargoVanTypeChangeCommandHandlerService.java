...
public class Step3_Length_2_CargoVanTypeChangeCommandHandlerService extends CommandHandlerService {
    //todo: add tests
    private static final Logger LOGGER = LoggerFactory.getLogger(Step3_Length_2_CargoVanTypeChangeCommandHandlerService.class);

    public Step3_Length_2_CargoVanTypeChangeCommandHandlerService(CargoDistributorBotService botService) {
        super(botService);
    }
