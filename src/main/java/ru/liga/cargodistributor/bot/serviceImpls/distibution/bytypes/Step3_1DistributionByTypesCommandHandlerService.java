...
public class Step3_1DistributionByTypesCommandHandlerService extends CommandHandlerService {
    //todo: add tests
    private static final Logger LOGGER = LoggerFactory.getLogger(Step3_1DistributionByTypesCommandHandlerService.class);

    public Step3_1DistributionByTypesCommandHandlerService(CargoDistributorBotService botService) {
        super(botService);
    }
