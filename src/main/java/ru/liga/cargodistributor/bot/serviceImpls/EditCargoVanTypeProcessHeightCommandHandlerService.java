...
@Service
public class EditCargoVanTypeProcessHeightCommandHandlerService extends CommandHandlerService {
    //todo: add tests
    private static final Logger LOGGER = LoggerFactory.getLogger(EditCargoVanTypeProcessHeightCommandHandlerService.class);

    @Autowired
    protected EditCargoVanTypeProcessHeightCommandHandlerService(@Value("${bot.token}") String token, @Value("${cache.capacity}") int cacheCapacity) {
        super(token, cacheCapacity);
    }

    public EditCargoVanTypeProcessHeightCommandHandlerService(
    ...
    public List<PartialBotApiMethod<Message>> processCommandAndGetResponseMessages(Update update) {
        ...
        cargoVanTypeInfoToUpdate.setHeight(vanHeight);
