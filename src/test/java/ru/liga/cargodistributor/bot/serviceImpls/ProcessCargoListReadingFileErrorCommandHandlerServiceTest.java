...
class ProcessCargoListReadingFileErrorCommandHandlerServiceTest {
    ...
    void processCommandAndGetResponseMessages() {
        ...
        CommandHandlerService handlerService = new ProcessCargoListReadingFileErrorCommandHandlerService(
